<template>
  <div class="signUp">
    ...
    >
      <div class="protocol">
        ...
        <div class="protocol_btn">
          <van-button
            class="protocol_btn--left"
            type="default"
            @click="protocol(0)"
            >拒绝</van-button
          >
          <van-button
            class="protocol_btn--right"
            type="info"
            @click="protocol(1)"
            >同意</van-button
          >
    ...
    >
      <div class="name">
        <p class="name_title">关于实名认证的说明</p>
        <div class="name_article">
          <p>
            根据《中华人名共和国广告法》以及国信办通字﹝2019﹞3号《网络音视频信息服务管理规定》，您必须完成实名认证；
          </p>
          <p>请选择用户身份，完成认证</p>
          <p>企业用户请填写组织机构名称和组织机构代码；</p>
          <p>个人用户请填写姓名和居民身份信息。</p>
        </div>
        <div class="name_btn">
          <van-button
            class="name_btn--item border-top border-right"
            type="default"
            @click="realName(0)"
            >取消</van-button
          >
          <van-button
            class="name_btn--item border-top"
            type="default"
            @click="realName(1)"
            >确认</van-button
          >
