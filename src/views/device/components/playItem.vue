        ...
        <div class="paltitem_top_img" @click="player">
          <template v-if="playInfo.mediaType === 0">
            <img
              ...
              :src="playInfo.addressOld + videoFrame"
              alt=""
            />
            <img
        ...
        <div class="paltitem_top_info">
          <div class="paltitem_top_info_des">
            ...
            <p class="paltitem_top_info_des--info van-ellipsis">
              ...
              <span class="padding-left">{{
                playInfo.mediaType | mediaTypeFilter
              }}</span>
            </p>
            <p class="paltitem_top_info_des--info van-ellipsis">
              播放时长
              <span class="padding-left">{{
                playInfo.mediaTime | filterLength
              }}</span>
            </p>
          </div>
          <div class="paltitem_top_info_btn">
            <span
              ...
              :class="disabled ? 'disabled-bottom' : ''"
              @click="changeOrder('up')"
            ></span>
            <span
              class="Triangle Triangle-up"
              :class="disabled ? 'disabled-up' : ''"
...
export default {
  ...
  methods: {
    ...
    player() {
      this.$router.push({
        path: "/mediaDetails",
        query: { id: this.playInfo.mediaId },
      });
    },
    // 隐藏按钮
    hiddenMedia(id) {
...
.Triangle-up {
  ...
  border-left-width: 0.095rem;
  border-right-width: 0.095rem;
